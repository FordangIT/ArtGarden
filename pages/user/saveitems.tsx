...
const getFavorites = (session: Session | null) => {
  const storage = session ? localStorage : sessionStorage; // 세션이 있으면 로컬 스토리지, 없으면 세션 스토리지 사용
...
export default function FavoritesPage() {
  ...
  useEffect(() => {
    ...
    setFavorites(getFavorites(session)); // 찜한 목록을 상태에 설정
  ...
  return (
    <div className="flex-col">
      ...
      {/* 찜한 목록이 모두 비어 있을 때 NosaveItems 컴포넌트 표시 */}
